...
def dump_user_activity_data(address, coinType, activityType, amount):
    dump_data('set/insert/db_celo_mainnet/tbl_user_activity', {'address': address[2:], 'coin_name': coinType, 'activity_type': activityType, 'amount': amount, 'agent_id':0}, 'GET')
