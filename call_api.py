...
def dump_user_activity_data(address, coinType, activityType, amount, amountOfDebtRepaid, healthFactor, liquidation_price_same_currency, tx_hash, timestamp, block_number):
