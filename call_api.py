...
def dump_user_activity_data(address, coinType, claimedCurrency, activityType, amount, amountOfDebtRepaid, healthFactor, liquidation_price_same_currency, tx_hash, timestamp, block_number):
